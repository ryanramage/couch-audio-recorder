...
(function($) {
    $.fn.couchLogin = function(opts) {
        ...
        initWidget();
        function succesLogin(resp) {
            if (opts.successLogin) {
                opts.successLogin(resp);
            }
            initWidget();
        };
        ...
        function doLogin(name, pass) {
            $.couch.login({name:name, password:pass, success:succesLogin});
        };
        ...
        elem.delegate("form.signup", "submit", function() {
            ...
            $.couch.signup({name : name}, pass, {
                ...
                error : function(status, req, e) {opts.error(status, req, e)}
            });
            return false;      
        });
    }
    ...
    function loggedIn(r) {
        ...
        , span = $('<span>Welcome <a  href="user.html" class="name"></a>! <a href="#logout">Logout?</a></span>');
